...
// Configurable variables
    ...
    params.fasta = params.genome ? params.genomes[ params.genome ].fasta ?: false : false
       //params.bwa_index = "/athena/elementolab/scratch/asd2007/projectshg38/datasets/ngi/data/hg38/bwa_index/GRCh38_no_alt_analysis_set_GCA_000001405.15.fasta"
    params.genome = "hg38"
    params.bwa_index = params.genome ? params.genomes[ params.genome ].bwa ?: false : false
    params.name = "Elemento-Melnick ChIP-seq Best Practice"
    params.reads = "data/bcl6/*{1,2}*.fastq.gz"
...
if (params.genome == 'hg38'){ REF_macs = 'hs'; REF_ngsplot = 'hg38' }
...
// Header log info
log.info "========================================="
log.info " Elemento-Melnick: ChIP-Seq Best Practice v${version}"
log.info "========================================="
def summary = [:]
...
process bwa {
    ...
    executor 'sge'
    scratch true
    clusterOptions '-l h_vmem=5G -pe smp 6-12 -l h_rt=26:00:00 -l athena=true'
    ...
    set -o pipefail
    ## spack load bwa
    bwa mem -t \${NSLOTS} -M /athena/elementolab/scratch/asd2007/reference/hg38/bwa_index/GRCh38_no_alt_analysis_set_GCA_000001405.15.fasta $reads | samtools view -bS -q 30 - > ${prefix}.bam
    ###bwa mem -t \${NSLOTS} -M /athena/elementolab/scratch/asd2007/reference/hg38/bwa_index/GRCh38_no_alt_analysis_set_GCA_000001405.15.fasta $reads | samtools view -bT -q 30 - > ${prefix}.bam
    """
}
